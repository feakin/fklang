...
mod tests {
  ...
  use crate::exec::code_gen_runner;
  ...
  fn test_java_package_to_path() {
    ...
    code_gen_runner::code_gen_by_path(&input_path, Some("HelloGot".to_string()), &base_path);
...
public class HelloController {
  ...
  fn panic_for_duplicated_method() {
    ...
    code_gen_runner::code_gen_by_path(&input_path, Some("index".to_string()), &base_path);
  }
